...
void seeExamHistrory(int client_socket){
    ...
    *history_list = malloc(sizeof(exam_result)*number_of_history_records);
    ...
    //free(history_list);
    UIMainAppMenuAdmin(client_socket);
}
...
void UIMainAppMenuAdmin(int client_sockfd){
    ...
    printf("4. Manage question database(Search, Add, Edit, Delete)\n");
    printf("5. Manage exam database(Search, Add, Edit, Delete)\n");
    printf("6. Manage exam room\n");
    printf("7. See exam room result\n");
    printf("8. See user information\n");
    printf("9. Chat with AI\n");
    printf("10. Log out\n");
