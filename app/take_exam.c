...
int main(int argc, char *argv[]) {
    ...
    // Tạo widget "take exam"
    take_exam_widget = create_take_exam();

    // Thêm widget "take exam" vào cửa sổ
    gtk_container_add(GTK_CONTAINER(window), take_exam_widget);
